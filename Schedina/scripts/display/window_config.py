...
def applayout(self):      
    ...
    self.prec = Button(size_hint=(0.2, 0.08), pos_hint={'center_x': .25, 'center_y': .1},
                              text='Precedente', font_size = 40, color = colors['text'], background_color = colors['label'])

    self.suc = Button(size_hint=(0.2, 0.08), pos_hint={'center_x': .75, 'center_y': .1},
                              text='Successivo', font_size = 40, color = colors['text'], background_color = colors['label'])
